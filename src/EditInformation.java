...
public class EditInformation {
    ...
    public static void editStock(DataManager dm, Scanner input) {
        ...
        switch (choice) {
            case 1 -> modifyStock(dm, input);
            case 2 -> modifySalesInTxt(input);
    ...
    private static void processEdit(List<String> record, Scanner input) {
        ...
        System.out.println("3. Transaction Method");
        ...
        // Maps the choice to the specific prefix used in your teammate's SalesSystem receipts
        String targetPrefix = switch (choice) {
            case 1 -> "Customer Name: ";
            case 2 -> "Quantity: ";
            case 3 -> "Transaction Method: ";
            case 4 -> "Total Price: RM";
            default -> "";
        };
